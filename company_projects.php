...
<html>
  ...
  <body>
    ...
    <div class="main_wrapper">
      <main>
        <section>
          <section class="wrapper_title_sort">
            <h1>הפרויקטים שלי</h1>
            <a class="sort_as" href="#">ממוין לפי תאריך פרסום</a>
            <form id="search" method="get" action="#">
              <input name="q" type="text" size="40" placeholder="חיפוש..."/>
            </form>
          </section>
        </section>
        <div class="content_wrapper">
          ...
          <div class="cards_wrapper">
            <article class="card add">
              <a class="content" href="new_project.php"></a>
            </article>
            <?php
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<article class='card project'>
                  ...
                  <a class='content' href='company_project_details.php'>
                  ...
                  <div class='actions_wrapper'>
                    <a href='edit_project.php' class='edit'><i class='material-icons'>mode_edit</i></a>
